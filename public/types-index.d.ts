...
export interface SortingProcess extends GenericProcess {
  type: 'sorting';
  toolInstance?: TokenIdOr<ToolInstance>;
  knowHow?: TokenIdOr<KnowHow>;
}

export interface QualityCheckProcess extends GenericProcess {
  type: 'quality check';
  toolInstance?: TokenIdOr<ToolInstance>;
  knowHow?: TokenIdOr<KnowHow>;
}

export interface LabelingProcess extends GenericProcess {
  type: 'labeling';
  toolInstance?: TokenIdOr<ToolInstance>;
  knowHow?: TokenIdOr<KnowHow>;
}
